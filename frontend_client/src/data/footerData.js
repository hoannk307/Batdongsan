export const FooterData = {
  ...
  usefulLinks: {
    ...
    children: [
      { title: "About us", link: "/pages/other-pages/about-us-2" },
      { title: "New Arrivals", link: "/batdongsan" },
  ...
  buy: {
    title: "Buy",
    children: [
      { title: "Home For Sale", link: "/batdongsan" },
      { title: "Open House", link: "/batdongsan" },
      { title: "New Listing", link: "/batdongsan" },
      { title: "Recently Reduce", link: "/batdongsan" },
      { title: "Off-Market Home", link: "/batdongsan" },
      { title: "Latest House", link: "/batdongsan" },
    ],
  },
  sell: {
    title: "Sell",
    children: [
      ...
      { title: "Get a Home Version", link: "/batdongsan" },
      { title: "Look Home Price", link: "/pages/other-pages/pricing" },
      { title: "Guide & Rules", link: "/pages/user-panel/privacy" },
      { title: "Sold Home & History", link: "/batdongsan" },
      { title: "Other", link: "/batdongsan" },
    ],
  },
  relandEstate: {
    title: "Reland Estate",
